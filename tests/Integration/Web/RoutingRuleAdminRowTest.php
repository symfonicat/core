...
final class RoutingRuleAdminRowTest extends SymfonicatKernelTestCase
{
    ...
    public function testRowLinksRouteBasedApplicationRuleWhenApplicationExists(): void
    {
        ...
        self::assertStringContainsString('<a href="/test"><code>symfonicat_subdomain_test</code></a>', $html);
        self::assertStringContainsString('<a href="/test"><code>core/test</code></a>', $html);
        self::assertStringContainsString('route', $html);
        self::assertStringNotContainsString('route: symfonicat_subdomain_test', $html);
    }
