...
final class RuntimeController extends AbstractController
{
    ...
    #[Route('/{path}', name: 'symfonicat_runtime', methods: ['GET'], requirements: ['path' => '(?!admin(?:/|$)|application(?:/|$)|m(?:/|$)).*'], defaults: ['path' => ''], priority: -1000, condition: 'request.attributes.get("symfonicat_runtime_route_allowed")')]
