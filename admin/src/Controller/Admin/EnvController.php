...
{
    #[Route('/admin/e', name: 'symfonicat_env_index', methods: ['GET', 'POST'])]
    ...
    #[Route('/admin/e/{id}', name: 'symfonicat_env_delete', methods: ['POST'])]
    ...
    #[Route('/admin/e/parent/{id}', name: 'symfonicat_env_parent_delete', methods: ['POST'])]
