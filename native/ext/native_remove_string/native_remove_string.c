...
PHP_FUNCTION(native_remove_string);

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_native_remove_string, 0, 2, IS_STRING, 0)
    ZEND_ARG_TYPE_INFO(0, value, IS_STRING, 0)
    ZEND_ARG_TYPE_INFO(0, needle, IS_STRING, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry native_remove_string_functions[] = {
    PHP_FE(native_remove_string, arginfo_native_remove_string)
    PHP_FE_END
};

zend_module_entry native_remove_string_module_entry = {
    STANDARD_MODULE_HEADER,
    "native_remove_string",
    native_remove_string_functions,
    NULL,
    NULL,
    NULL,
    NULL,
...
ZEND_GET_MODULE(native_remove_string)
