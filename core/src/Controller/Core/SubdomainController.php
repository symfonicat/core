...
final class SubdomainController extends AbstractController
{
    ...
    #[Route('/core/s', name: 'symfonicat_subdomain_index', methods: ['GET'])]
    public function index(SubdomainRepository $subdomainRepository, EnvParentRepository $envParentRepository): Response
    {
        return $this->render('@symfonicat/subdomain/index.html.twig', [
            'subdomains' => $subdomainRepository->findAllOrderedByAffix(),
            'env_parents' => $envParentRepository->findAllOrdered(),
        ]);
    }


    #[Route('/core/s/create', name: 'symfonicat_subdomain_create', methods: ['GET', 'POST'])]
    ...
    #[Route('/core/s/{id}', name: 'symfonicat_subdomain_edit', methods: ['GET', 'POST'], requirements: ['id' => '.+'])]
    ...
    #[Route('/core/s/{id}/delete', name: 'symfonicat_subdomain_delete', methods: ['POST'], requirements: ['id' => '.+'], priority: 10)]
