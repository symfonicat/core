...
{
    #[Route('/core/e', name: 'symfonicat_endpoint_index', methods: ['GET'])]
    ...
    #[Route('/core/e/create', name: 'symfonicat_endpoint_create', methods: ['GET', 'POST'])]
    ...
    #[Route('/core/e/{id}', name: 'symfonicat_endpoint_edit', methods: ['GET', 'POST'], requirements: ['id' => '.+'])]
    ...
    #[Route('/core/e/{id}/delete', name: 'symfonicat_endpoint_delete', methods: ['POST'], requirements: ['id' => '.+'], priority: 10)]
