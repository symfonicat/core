...
{
    #[Route('/core/y/dump', name: 'symfonicat_core_yaml_dump', methods: ['GET'])]
    ...
    #[Route('/core/y/load', name: 'symfonicat_core_yaml_load', methods: ['GET'])]
    ...
    private function redirectAfterAction(Request $request): RedirectResponse
    {
        ...
        if (is_string($referer) && $referer !== '' && !str_contains($referer, '/core/y/')) {
