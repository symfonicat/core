...
final class RoutingRuleController extends AbstractController
{
    ...
    {
        return $this->render('routing_rule/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('routing_rule/create.html.twig', [
            'rule' => $rule,
            'form' => $form,
        ]);
    }
    ...
    public function show(string $id, RoutingRuleRepository $routingRuleRepository): Response
    {
        ...
        return $this->render('routing_rule/show.html.twig', [
            'rule' => $rule,
        ]);
    }
    ...
    public function edit(Request $request, string $id, RoutingRuleRepository $routingRuleRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('routing_rule/edit.html.twig', [
            'rule' => $rule,
            'form' => $form,
        ]);
    }
